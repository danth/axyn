...
class CustomHelpCommand(commands.HelpCommand):
    ...
    async def send_bot_help(self, mapping):
        ...
        embed = discord.Embed(
            title='Help',
            description=
            'See `c!help <command>` or `c!help <category>` for more help.',
            color=HELP_COLOR)
    ...
    async def send_cog_help(self, cog):
        ...
        embed = discord.Embed(
            title='Help',
            description='See `c!help <command>` for more help on a command.',
            color=HELP_COLOR)
    ...
    async def send_command_help(self, command):
        ...
        # Add usage
        usage = f'**c!{command.qualified_name} {command.signature}**'
    ...
    async def send_group_help(self, group):
        ...
        # Add usage
        usage = f'**c!{group.qualified_name} {group.signature}**'
        embed.add_field(name='Usage', value=usage, inline=False)
